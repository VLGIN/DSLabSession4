...
def gen_data_and_vocab():
    ...
    vocab.sort()
    with open('dataset/w2v/vocab-raw.txt', 'w+') as f:
        f.write('\n'.join(vocab))
    ...
    with open('dataset/w2v/20news-train-raw.txt', 'w+') as f:
        f.write('\n'.join(train_data))
    with open('dataset/w2v/20news-test-raw.txt', 'w+') as f:
        f.write('\n'.join(test_data))
...
if __name__ == '__main__':
    MAX_DOC_LENGTH = 500
    gen_data_and_vocab()
    encode_data('dataset/w2v/20news-train-raw.txt', 'dataset/w2v/vocab-raw.txt')
    encode_data('dataset/w2v/20news-test-raw.txt', 'dataset/w2v/vocab-raw.txt')